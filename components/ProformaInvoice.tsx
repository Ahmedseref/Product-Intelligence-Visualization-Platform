...
type SubView = 'list' | 'create' | 'preview';
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 px-6 py-5 border-b border-slate-200 bg-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Create and manage proforma invoices with inline editing</p>
            </div>
          </div>
          <button
        ...
        {/* Search */}
        <div className="mt-4 flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg w-72">
